...
# WITH RANDOM SAMPLE DUE TO BIG DATA: FIX BEFORE SENDING
...
6. Next, move to GLMs. Investigate the plausibility of a Poisson and/or a Negative Binomial model fits the data better.
...
```{r , message=FALSE, warning=FALSE}
p_load(ezknitr)
ezknit(file = "code.Rmd", out_dir = "docs", keep_html = TRUE, keep_md = FALSE, params = list("dat" = "dat.RData"))
```